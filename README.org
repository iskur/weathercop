...
This installs the package with all dependencies (including VarWG from PyPI).
...
The example uses WeatherCop's bundled example data and configuration. No setup needed—just import and run!

#+begin_src python :tangle src/weathercop/examples/quick_start.py
import xarray as xr
...
#+CAPTION: Daily meteogram visualization across multiple stations
[[./examples/plots/ensemble_meteogram_0.png]]
[[./examples/plots/ensemble_meteogram_1.png]]
[[./examples/plots/ensemble_meteogram_2.png]]

#+CAPTION: Q-Q plot comparing simulated and empirical quantiles
