...
\begin{footnotesize}
  ...
  \tikzstyle{block} = [rectangle, draw, text width=\blockwidth,
  text centered, rounded corners, minimum height=\minheight]

  \tikzstyle{normblock} = [rectangle, draw, fill=gray!40, text
  width=\blockwidth, text centered, rounded corners, minimum
  height=\minheight]

  \tikzstyle{rainblock} = [rectangle, draw, fill=blue!40, text
  width=\blockwidth, text centered, rounded corners, minimum
  height=\minheight]

  \tikzstyle{cloud} = [draw, circle, text centered, text
